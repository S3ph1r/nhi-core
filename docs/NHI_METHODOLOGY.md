...
|-----------|-------------|
| **SSOT** | Single Source of Truth - Never guess, always consult |
| **Declarative** | Infrastructure and services described as code/manifests |
| **Self-Aware** | System knows itself through automated scanning |
| **AI-Native** | Designed for AI agents to understand and operate |
...
| **Config files** | `lowercase.yaml` | `config.yaml`, `secrets.yaml` |
...
| `README.md` | Project root | Getting started guide |
